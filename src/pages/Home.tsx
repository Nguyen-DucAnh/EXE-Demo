    ...
    <div className="space-y-12">
      ...
      <section className="text-center space-y-8 py-16 relative overflow-hidden">
        ...
        <div className="flex gap-4 justify-center flex-wrap pt-4">
          <Button size="lg" asChild className="bg-gradient-to-r from-sky-600 to-indigo-600 hover:from-sky-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transition-all">
            <Link to="/knowledge">
              Khám phá kiến thức <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
          <Button size="lg" variant="outline" asChild className="border-2 border-sky-300 text-sky-700 hover:bg-sky-50 hover:border-sky-400 transition-all">
            <Link to="/assistant">
      ...
      {/* Features */}
      <section>
        <h2 className="text-4xl font-bold text-center mb-12 bg-gradient-to-r from-sky-700 to-amber-500 bg-clip-text text-transparent">Tại sao chọn HeyPaaaa?</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="hover-lift border-2 border-transparent hover:border-sky-200 transition-all bg-gradient-to-br from-white to-sky-50/50">
            <CardHeader>
              <div className="h-14 w-14 rounded-full bg-gradient-to-r from-sky-500 to-indigo-500 flex items-center justify-center mb-4">
          ...
          <Card className="hover-lift border-2 border-transparent hover:border-amber-200 transition-all bg-gradient-to-br from-white to-amber-50/50">
            <CardHeader>
              <div className="h-14 w-14 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 flex items-center justify-center mb-4">
      ...
      {/* Life Stages */}
      <section>
        <h2 className="text-4xl font-bold text-center mb-12 bg-gradient-to-r from-sky-700 to-amber-500 bg-clip-text text-transparent">Các giai đoạn trong hành trình</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stages.map((stage) => (
            <Card key={stage} className="hover-lift border-2 border-transparent hover:border-sky-200 transition-all bg-gradient-to-br from-white to-sky-50/30">
              <CardHeader>
                <CardTitle className="text-xl mb-4">{getStageLabel(stage)}</CardTitle>
              </CardHeader>
              <CardContent>
                <Button variant="outline" asChild className="w-full border-2 border-sky-200 text-sky-700 hover:bg-sky-50 hover:border-sky-300 transition-all">
      ...
      {/* CTA */}
      <section className="text-center py-16 bg-gradient-to-r from-slate-50 via-sky-50 to-amber-50 rounded-3xl border-2 border-slate-100 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-sky-100/50 to-amber-100/50 opacity-50"></div>
        <div className="relative z-10">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-sky-700 to-amber-500 bg-clip-text text-transparent">Sẵn sàng bắt đầu?</h2>
